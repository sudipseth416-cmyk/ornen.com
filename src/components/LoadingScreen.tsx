    ...
    <AnimatePresence>
      {isLoading && (
        ...
        >
          ...
          >
            <div className="absolute w-[80vw] h-[80vw] md:w-[40vw] md:h-[40vw] bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-[#00f0ff]/10 via-transparent to-transparent opacity-60 mix-blend-screen" />
            <motion.div 
              animate={{ rotate: [0, 360] }}
              transition={{ repeat: Infinity, duration: 25, ease: "linear" }}
              className="absolute w-[150%] h-[150%] bg-[conic-gradient(from_90deg_at_50%_50%,#00000000_0%,#c9a84c05_50%,#00000000_100%)]"
            />
          </motion.div>
          ...
          <div className="relative z-10 flex flex-col items-center justify-center w-full h-full">
            ...
            <motion.div
              ...
              className="relative flex items-center justify-center w-64 h-64 sm:w-80 sm:h-80 mb-16"
            >
              ...
              <motion.div
                ...
                className="absolute inset-[5%] rounded-full border-t border-[#00f0ff]/40 mix-blend-screen filter blur-[2px]"
              />
              ...
              >
                <Image
                  ...
                  fill
                  priority
                  className="object-contain drop-shadow-[0_0_30px_rgba(0,240,255,0.3)]"
                />
              </motion.div>
            </motion.div>
            ...
            <motion.div
              ...
              className="flex flex-col items-center w-72 sm:w-96"
            >
              <div className="h-5 overflow-hidden relative mb-6 w-full flex justify-center">
                <AnimatePresence mode="wait">
                  <motion.div
                    ...
                    className="text-[#c9a84c] tracking-[0.5em] uppercase text-[11px] font-semibold whitespace-nowrap drop-shadow-[0_0_8px_rgba(201,168,76,0.6)]"
                  >
                    {loadingText}
                  </motion.div>
                </AnimatePresence>
              ...
              <div className="w-full h-[1px] bg-white/5 relative overflow-hidden">
                ...
                <motion.div
                  ...
                  animate={{ left: "100%" }}
                  transition={{ duration: 3.1, ease: [0.85, 0, 0.15, 1] }}
                  className="absolute top-0 w-10 h-full bg-white shadow-[0_0_15px_2px_#fff] blur-[2px]"
                />
              </div>
            </motion.div>
          </div>
