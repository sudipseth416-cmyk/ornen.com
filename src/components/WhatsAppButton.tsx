    ...
    <div className="fixed bottom-6 right-6 z-[9999] flex flex-col gap-4">
      ...
      <motion.div
        ...
        transition={{
          repeat: Infinity,
          duration: 2,
          delay: 0 // Offset animation
        }}
        className="rounded-full"
      >
        <a
          href="https://www.instagram.com/ornen_creature_webdeveloper?igsh=NGVuZzBrc2JhM2g5"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center w-14 h-14 bg-gradient-to-tr from-[#f09433] via-[#e6683c] to-[#bc1888] text-white rounded-full shadow-lg hover:scale-110 transition-transform duration-300"
      ...
      <motion.div
        ...
        transition={{
          repeat: Infinity,
          duration: 2,
          delay: 0.6 // Offset animation from the others
        }}
        className="rounded-full"
      >
        <a
